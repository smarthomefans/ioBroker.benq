...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new benq name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/admin/benq.png')) {
            fs.renameSync(__dirname + '/admin/benq.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/benq.html')) {
            fs.renameSync(__dirname + '/widgets/benq.html',           __dirname + '/widgets/' + newname + '.html');
        }
        if (fs.existsSync(__dirname + '/widgets/benq/js/benq.js')) {
            fs.renameSync(__dirname + '/widgets/benq/js/benq.js', __dirname + '/widgets/benq/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/benq')) {
            fs.renameSync(__dirname + '/widgets/benq',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /Benq/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Benq'
                        },
                        {
                            match: /instalator/g,
                            replacement: author
